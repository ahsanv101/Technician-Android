...
//                        Toast.LENGTH_SHORT).show();
        ...
        if (isServiceRunning(TrackerService.class)) {
            ...
            //spinner1 = (Spinner) findViewById(R.id.spinner1);
            //spinner1.getAdapter().getItem()
            //  spinner1.getAdapter().getItem(getIndex(spinner1, mPrefs.getString(getString(R.string.branch_prompt), ""))).toString();
            //  int selectionPosition= spinner;
